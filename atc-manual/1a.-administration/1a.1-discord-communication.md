...
| #readonly              | Day to day posts (such as housekeeping and event specific procedures) to be made in this channel by the ATC Manager, Staff and Moderators only. Controllers **must not**{.red} reply to any material posted in this channel so that all Controllers can be reached effectively |
