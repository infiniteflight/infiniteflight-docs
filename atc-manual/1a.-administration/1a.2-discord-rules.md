...
- The *#controlling[1-3]* voice channels **must**{.red} only be used by members who are actively controlling with other Controllers
- Coordination of the *#controlling[1-3]* voice channels **must**{.red} only occur in *#controllers*
...
- Further guidance on the use of VC's can be found in Discord Communication *(see [1A.1.4](/guide/atc-manual/1a.-administration/1a.1-discord-communication#1a.1.4) above)*
