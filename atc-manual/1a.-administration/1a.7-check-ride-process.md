...
> Controllers that are currently in the Officer Check Ride phase **must not**{.red} control any facility (including Center) at stream or FF featured airports *(airports from the ATC Schedule or other official events are permitted unless indicated otherwise - see [1A.4.1](/guide/atc-manual/1a.-administration/1a.4-airport-selection#1a.4.1) above)*
