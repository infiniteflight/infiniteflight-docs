...
All Violations are tracked and recorded. Controllers that are found to abuse the system will be given warning, suspension or removal from IFATC *(see [1A.6](/guide/atc-manual/1a.-administration/1a.6-disciplinary-and-suspension-procedure) above)*. If a Controller is unsure if issuing a Violation is necessary, they **should**{.red} ask a Supervisor or above for guidance.
