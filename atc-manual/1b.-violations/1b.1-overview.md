...
: Consistency **must**{.red} be maintained and therefore Controllers must not hesitate to issue a Violation when the proper procedures have been applied. Tolerance however, is equally as important – Controllers **should**{.red} try to put themselves in the pilot’s position to determine if it was malicious or a genuine mistake
