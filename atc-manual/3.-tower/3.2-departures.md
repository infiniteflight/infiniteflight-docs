...
> If there is an aircraft that has been cleared for take-off, the next aircraft that is holding short is considered number 1 for departure (assuming an aircraft has not been cleared to LUAW). If an aircraft has been instructed to LUAW, the next aircraft holding short is considered number 2 for departure
