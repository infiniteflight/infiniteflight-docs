...
SIDs often involve turns away from the airport shortly after departure; due to this, if 'Straight Out Dept.' is being utilised, Controllers **should**{.red} note that this may prevent pilots from flying the selected SID *(see 4.1.6 and 8.4.3 below)*.
