...
| FPL Required          | Only to be used when weather is below VMC minima *(see [3.4](/guide/atc-manual/3.-tower/3.4-pattern-work-transitions-flight-of-xx#3.4-pattern-work-%2F-transitions-%2F-flight-of-xx) above)*. |
