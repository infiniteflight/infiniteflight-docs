...
Pattern work **must**{.red} be denied if the weather conditions, terrain or traffic are not suitable *(see [3.3](/guide/atc-manual/3.-tower/3.3-pattern-work-transitions-flight-of-xx#3.3-pattern-work-%2F-transitions-%2F-flight-of-xx) above)*
...
| --------------------- | ------------------------------------------------------------ |
| No Intersection Dept. | Intersection departures **must**{.red} always be allowed unless it blocks the only taxiway for aircraft to access full length **AND**{.red} will affect the departure/arrival flow rate *(see [3.2.4](/guide/atc-manual/3.-tower/3.2-departure#3.2.4) above)*. |
| No Pattern Work       | Weather below VMC? Terrain prevents a standard pattern from being flown? **CURRENT**{.red} traffic levels will cause a drop in service standards? When 1 of these conditions is met, No Pattern Work **must**{.red} be used *(see [3.3.1](/guide/atc-manual/3.-tower/3.3-pattern-work-transitions-flight-of-xx#3.3.1) above)*. |
...
| FPL Required          | Only to be used when weather is below VMC minima *(see [3.3](/guide/atc-manual/3.-tower/3.3-pattern-work-transitions-flight-of-xx#3.3-pattern-work-%2F-transitions-%2F-flight-of-xx) above)*. |
| Straight Out Dept. ** | Runway heading **must**{.red} be flown after departure until no conflict exists **AND**{.red} the altitude specified by the Tower Controller has been met or exceeded *(see [3.2.7](/guide/atc-manual/3.-tower/3.2-departure#3.2.7) above)*. |
...
| Size Restrictions     | When any aircraft cannot be accommodated because their size will restrict airport flow (i.e. block taxiways or ramp areas), this command **must**{.red} be used. Controllers **should**{.red} note that the app will restrict aircraft from spawning at an airport gate that is too small for the aircraft type, therefore this command **must not**{.red} be used for this purpose *(see [2.1.1](/guide/atc-manual/2.-ground/2.1-runway-selection-and-pushback#2.1.1) above)*. |
...
**Take note that the use of 'Straight Out Dept.' may prevent aircraft from flying their selected SID *(see [3.2.8](/guide/atc-manual/3.-tower/3.2-departure#3.2.8) above)*
