...
: It is the responsibility of the Candidate/Controller to ensure they meet the minimum requirements *(see [1A.3.1](/guide/atc-manual/1a.-new-entrants/1a.3-rank-structure#1a.3.1) above)* **BEFORE**{.red} seeking training. Failure to do so may invalidate the training request and further progression may not be granted for a period of time
