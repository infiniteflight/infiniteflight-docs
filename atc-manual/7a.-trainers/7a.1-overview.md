...
The use of Voice Channels for coordination between Trainers and their Trainees **must**{.red} be conducted in accordance with Section 1A - New Entrants *(see [1A.1.6](/guide/atc-manual/1a.-new-entrants/1a.1-discord-communication-guidelines#1a.1.6) and [1A.2.1](/guide/atc-manual/1a.-new-entrants/1a.2-general-rules#1a.2.1) above)*. It’s intended use is for one-on-one training through the session and may also be used to debrief and provide pilot feedback that the Trainer has compiled. It is entirely voluntary and at the discretion of the Trainer and Trainee. 