...
| #trainingrequests | Notifications of Candidates/Controllers that have entered the Training Pool will be sent to this channel and can be acknowledged by using the green checkmark emoji *(see [7A.2.3](/guide/atc-manual/7a.-trainers/7a.2-training-structure#7a.2.3) below)*. Threads **should**{.red} be used to the maximum extent possible. |
