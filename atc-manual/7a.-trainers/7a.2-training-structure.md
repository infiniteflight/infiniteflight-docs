...
Trainees **should**{.red} be claimed within a 7 day timeframe by accepting the request *(see [7A.3.1](/guide/atc-manual/7a.-trainers/7a.3-trainer-admin#7a.3.1) below).*



### 7A.2.3

Once a Trainer has accepted a training request *(see [7A.3.1](/guide/atc-manual/7a.-trainers/7a.3-trainer-admin#7a.3.1) below)*, the Trainer **must**{.red} message the Trainee to begin dialogue and to organize training sessions. There is currently no schedule available and so Trainers are requested to liaise with all other Trainers to avoid booking over the same time slots.
