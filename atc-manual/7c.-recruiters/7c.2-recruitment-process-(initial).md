...
: Templates are available to Recruiters to help standardize the recruitment process *(see [7C.2.9](/guide/atc-manual/7c.-recruiters/7c.2-recruitment-process-(initial)#7c.2.9) below)*
...
Below is a list of the different templates available that can be sent on the IFC. Recruiters **should**{.red} try to use these as often as possible to give Users a standardized experience, however at times it may be necessary to message outside of these or to customize them:
