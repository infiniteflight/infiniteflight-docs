...
: Use the ATC Dashboard (a link is available within the *#recruiters* channel and login credentials are provided on joining the Recruitment Team) to check the profile of the Recruit, they must meet the minimum requirements to continue *(see [7C.2.4](/guide/atc-manual/7c.-recruiters/7c.2-recruitment-process-(initial)#7c.2.4) above)*
...
> Returning members of IFATC may not be required to complete The Initial Theory Test *(see [7C.2.8](/guide/atc-manual/7c.-recruiters/7c.2-recruitment-process-(initial)#7c.2.8) above)*
...
: Provided the requirements are met *(see [7C.2.5](/guide/atc-manual/7c.-recruiters/7c.2-recruitment-process-(initial)#7c.2.5) above)*, tick the "Written Phase" box under "Recruit Progress" using the steps outlined above *(see [7C.4.3](/guide/atc-manual/7c.-recruiters/7c.4-recruiter-admin#7c.4.3) above)*
...
: Provided the requirements are met *(see [7C.2.6](/guide/atc-manual/7c.-recruiters/7c.2-recruitment-process-(initial)#7c.2.6) above)*, tick the "Practical Phase" box under "Recruit Progress" using the steps outlined above *(see [7C.4.3](/guide/atc-manual/7c.-recruiters/7c.4-recruiter-admin#7c.4.3) above)*
...
: Send the corresponding PM using the "PM Templates" *(see [7C.2.6](/guide/atc-manual/7c.-recruiters/7c.2-recruitment-process-(initial)#7c.2.6) above)*
...
: To add ATC permissions for a successful Recruit, see the pinned instructions in the *#recruiters* Discord Channel
