...
| ---------------------- | ------------------------------------------------------------ |
| Correct Template Reply | If the original message includes all the information required to process the appeal *(see [7E.2.3](/guide/atc-manual/7e.-appeals/7e.2-appeals-process#7e.2.3) above)* |
