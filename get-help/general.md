...
: If your device doesn’t have iOS 15 operating system or later, you will still be able to enjoy Infinite Flight on versions prior to 24.1. To find out if your device meets these requirements, check [here](https://infiniteflight.com/timeline/21-6-ios-support)

+++



## Will I have to repurchase IAPs (in-app purchases) every time I redownload Infinite Flight?

All App Stores selling Infinite Flight and its associated in-app purchases allow for downloading without repurchasing after an item has been paid for.

If you’re an Android user your previous purchases will automatically be unlocked when you download the app. iOS users must open the aircraft selection page, then tap “Restore Purchases” to access any previously purchased regions and aircraft.



To ensure success, please check the following:
...
> If none of the above are applicable, uninstalling and then reinstalling the app often resolves the issue
...
If you still wish to receive a refund, the following processes are followed depending on which App Store was used:
...
iTunes policy is that all app sales are final. We are not able to provide refunds, but you may be able to receive a refund by emailing iTunes customer service with your request
...
Unfortunately new updates will not be released for Amazon devices. We will gauge Amazon demand at a later date to determine whether or not we will continue to support the Amazon App Store updates. The version prior to *Global* will remain available at this time.



## How can I join the Beta Team?

We do not accept direct requests to be an Alpha or Beta Tester. Keep an eye out here on the [Community Forum](https://community.infiniteflight.com) for future openings!
...
## How do I switch cockpits for the Cessna 172?

The cockpit of the C172 can be changed by selecting a different livery. The table below shows which panels are with each livery:
...
This usually happens when the scenery stream from our servers to your device becomes corrupt. To resolve this issue, please try the following steps:
...
: Before starting a new flight, go to Settings > General and then tap “Clear scenery cache”
...
> In some rare cases, the steps above might not be enough. In that case, please reinstall the app



## I can't hear any ATC voices on my device

If you are experiencing issues related to voices, please follow the steps below:
...
> Depending on the Android version, your TTS settings could be placed a bit differently. If you can’t find them using the steps above, try Settings > General Management > Language input > Text to speech > Cogwheel next to your preferred TTS engine
...
: Once here you will see tables for voices broken down by English (e.g. US, Australia, India, Ireland etc.)
...
Step 1
 ...
 : Ensure your device meets the [minimum device requirements](/guide/get-help/general#minimum-device-requirements). If it doesn't, then you will not be able to update Infinite Flight to the latest version



Step 2

 : Check to see if your device is Google Play Protect certified. You can do this by opening the Google Play Store, tap on Main Menu > Settings and check "Play Protect certification" under "About" (it should say "Device is certified")



If your device is not certified, this is because Google cannot validate the security or compatibility status of your device. To resolve this, ensure that:
