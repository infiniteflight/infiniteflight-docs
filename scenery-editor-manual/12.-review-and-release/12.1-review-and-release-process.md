...
Following an airport being approved and marked as ready for release, some changes may only can only be visible in-app when the next navigation database update is completed. This is usually at the same time as a release. This applies to:
