...
| Build Taxiway Layout      | **TBC**{.red}                                                |
| Check Taxiway Layout      | **TBC**{.red}                                                |
| Set as Apron              | This will rename any taxiway(s) selected as APRON. This **should**{.red} be done for any taxiways that are not named on charts |
| Freeze Non Taxi Line      | **TBC**{.red}                                                |
| Select Invalid Taxilines  | **TBC**{.red}                                                |
| Select Lines Near Start   | Selects all lines near start spawn points so that they can be recategorised as non taxiway routable lines (these are the lines that are used for aircraft nose wheels to park on) **(need to add properties > taxiway network usage > none)**{.red} |
...
| Button                   | Function                                                     |
| ------------------------ | ------------------------------------------------------------ |
| Check Jetbridges         | Checks all start locations for errors such as jet bridges not reaching doors. Color coded *(see 7.5.1 below)* |
| Freeze Non Jetbridges    | This is an editing mode for jet bridges (only allowing the selection of jet bridge end sections and start locations) which is recommended whenever working with jet bridges |
| Auto Assign Gates        | Automatically assigns jet bridges to gates                   |
