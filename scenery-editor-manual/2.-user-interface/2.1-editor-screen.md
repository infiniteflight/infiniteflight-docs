...
| Button                   | Function                                                     |
| ------------------------ | ------------------------------------------------------------ |
| Check Jetbridges         | Checks all start locations for errors such as jet bridges not reaching doors. These are color coded *(see [10.4.1](/guide/scenery-editor-manual/10.-airport-gates/10.4-jet-bridge-animations#10.5.1) below)* |
...
| Auto Assign Gates        | Automatically assigns jet bridges to gates *(see [10.4.4](/guide/scenery-editor-manual/10.-airport-gates/10.4-jet-bridge-animations#10.5.4) below)* |
