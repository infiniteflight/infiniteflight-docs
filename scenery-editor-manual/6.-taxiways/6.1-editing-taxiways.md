...
| Add red gate outlines using white lines                      | Add lights to lines that do not have lighting IRL (especially centerline lights to stand lines unless official documentation says otherwise) |
| Add correct aircraft categories and taxiway names to lines according to official documentation | Add runway markings including markings for displaced thresholds and blast pads |
|                                                              | Add Xs to closed taxiways                                    |
