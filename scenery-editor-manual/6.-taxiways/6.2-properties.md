...
| Direction             | Two Way, Forward, Backward and None can be selected          | See [6.2.5](/guide/scenery-editor-manual/6.-taxiways/6.2-properties#6.2.5) below |
...
| Taxiway Network Usage | Unknown, Aircraft or None can be selected                    | See [6.2.3](/guide/scenery-editor-manual/6.-taxiways/6.2-properties#6.2.3) below |
...
| Name                  | You can name the taxiway using this field                    | All taxiways **must**{.red} be named appropriately (i.e. "A" for Alpha taxiway). See [6.2.4](/guide/scenery-editor-manual/6.-taxiways/6.2-properties#6.2.4) below |
...
| Aircraft   | Yes                      | Centerlines and hold lines                                |
| None       | No                       | Stop bars, taxiway edge lines, roadways and gate outlines |
