...
Once jet bridges are added, properties and animations can be adjusted *(see [8.4.2](/guide/scenery-editor-manual/8.-airport-gate/8.4-jet-bridges#8.4.2) and [8.5](/guide/scenery-editor-manual/8.-airport-gates/8.5-jet-bridge-animations) below)*.
