...
As well as the general properties listed above, Jet Bridges have two other sets of properties, these are "Gates" and "Animations". Animations must not be edited under any circumstances so only the Gate properties are listed below:
