...
After naming all taxiways/hold lines, assigning the taxiway network usage and drawing all taxiway connections, you can build the taxiway network as described below (If you have recently changed runway identifiers, or added new ones, the taxiway network checker will fail, until the main airport database has been updated just before a release):
