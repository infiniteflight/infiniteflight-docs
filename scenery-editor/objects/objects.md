...
| ![](_images/manual/tables/turbine_vents_01.png) | Large Unit 1 |             |
| ![](_images/manual/tables/turbine_vents_02.png) | Large Unit 2 |             |
| ![](_images/manual/tables/turbine_vents_03.png) | Large Unit 3 |             |
...
| Image                                              | Object Name   | Description |
| -------------------------------------------------- | ------------- | ----------- |
| ![](_images/manual/tables/klax_theme_building.png) | KLAX Terminal |             |
...
| ![](_images/manual/tables/pallet_dolly.png)        | Pallet Dolly        |             |
...
| Image                                                | Object Name   | Description |
| ---------------------------------------------------- | ------------- | ----------- |
| ![](_images/manual/tables/pipes_steel_single_01.png) | Steel Pipe 1  |             |
| ![](_images/manual/tables/pipes_steel_single_02.png) | Steel Pipe 2  |             |
...
| Image                                                        | Object Name                      | Description |
| ------------------------------------------------------------ | -------------------------------- | ----------- |
| ![](_images/manual/tables/chainlink_fence_end.png)           | Chainlink Fence (End)            |             |
| ![](_images/manual/tables/chainlink_fence_middle.png)        | Chainlink Fence (Middle)         |             |
...
| ![](_images/manual/tables/oshkosh_striker_4500_red.png)    | Oshkosh Striker 4500 (Red)    |             |
| ![](_images/manual/tables/oshkosh_striker_4500_yellow.png) | Oshkosh Striker 4500 (Yellow) |             |
...
| Image                                | Object Name | Description |
| ------------------------------------ | ----------- | ----------- |
| ![](_images/manual/tables/donut.png) | Donut       |             |
...
| ![](_images/manual/tables/fuel_pump_self_serve.png) | Fuel Pump (Self Serve) |             |
| ![](_images/manual/tables/ground_power_unit.png)    | Ground Power Unit      |             |
| ![](_images/manual/tables/light_small.png)          | Light (Small)          |             |
...
| ![](_images/manual/tables/small_stairs.png) | Small Stairs |             |
| ![](_images/manual/tables/towbar.png)       | Towbar       |             |
...
| Image                                               | Object Name       | Description |
| --------------------------------------------------- | ----------------- | ----------- |
| ![](_images/manual/tables/cage_ladder_02.png)       | Ladder 2          |             |
...
| Image                                               | Object Name | Description |
| --------------------------------------------------- | ----------- | ----------- |
| ![](_images/manual/tables/solar_panel_flat_1.png)   | Flat 1      |             |
| ![](_images/manual/tables/solar_panel_flat_2.png)   | Flat 2      |             |
| ![](_images/manual/tables/solar_panel_flat_3.png)   | Flat 3      |             |
| ![](_images/manual/tables/solar_panel_flat_4.png)   | Flat 4      |             |
| ![](_images/manual/tables/solar_panel_tilted_1.png) | Tilted 1    |             |
| ![](_images/manual/tables/solar_panel_tilted_2.png) | Tilted 2    |             |
| ![](_images/manual/tables/solar_panel_tilted_3.png) | Tilted 3    |             |
| ![](_images/manual/tables/solar_panel_tilted_4.png) | Tilted 4    |             |
...
| Image                                       | Object Name  | Description |
| ------------------------------------------- | ------------ | ----------- |
| ![](_images/manual/tables/tug_large_1.png)  | Tug Large 1  |             |
...
| ![](_images/manual/tables/vehicle_suv_01_blue.png)         | Various Sedans/SUVs             |             |
