...
| ![](_images/manual/tables/ac_unit_6.png)        | Unit 6       | Must be placed next to a wall. [Altitude](/guide/scenery-editor/objects/properties) can be adjusted if object needs to be above ground level |
| ![](_images/manual/tables/ac_unit_7.png)        | Unit 7       | Must be placed next to a wall. [Altitude](/guide/scenery-editor/objects/properties) can be adjusted if object needs to be above ground level |
...
| ![](_images/manual/tables/electrical_equipment_building.png) | Electrical Equipment Building | See [Technical Locations](/guide/scenery-editor/objects/technical-locations) |
| ![](_images/manual/tables/runway_guard_lights.png)           | Runway Guard Lights           | See [Technical Locations](/guide/scenery-editor/objects/technical-locations#holding-point-lights) |
| ![](_images/manual/tables/windsock.png)                      | Windsock                      | Optional: Editors can [adjust](/guide/scenery-editor/objects/properties) the orientation and wind strength indicator of windsocks if they wish to do so |
...
| Image                                                 | Object Name    | Notes                                                        |
| ----------------------------------------------------- | -------------- | ------------------------------------------------------------ |
| ![](_images/manual/tables/ils_localizer_antenna.png)  | ILS Localizer  | See [Technical Locations](/guide/scenery-editor/objects/technical-locations#localizer) |
| ![](_images/manual/tables/ils_glideslope_antenna.png) | ILS Glideslope | See [Technical Locations](/guide/scenery-editor/objects/technical-locations#glideslope) |
| ![](_images/manual/tables/vor.png)                    | VOR            | See [Technical Locations](/guide/scenery-editor/objects/technical-locations#vor) |
| ![](_images/manual/tables/vor_small.png)              | VOR (Small)    | See [Technical Locations](/guide/scenery-editor/objects/technical-locations#vor) |
...
| Image                                              | Object Name   | Notes                     |
| -------------------------------------------------- | ------------- | ------------------------- |
| ![](_images/manual/tables/klax_theme_building.png) | KLAX Terminal | Do not use unless at KLAX |
...
| ![](_images/manual/tables/light_small.png)          | Light (Small)          | Optional: by placing multiple lights in the same position,  editors can [adjust](/guide/scenery-editor/objects/properties) the orientation to create a single pole that has multiple lights |
...
| ![](_images/manual/tables/small_stairs.png) | Small Stairs | Optional: sometimes it can appear more in proportion if the [scale](/guide/scenery-editor/objects/properties) is reduced to between 0.6-0.8 |
...
| Image                                               | Object Name       | Notes                                                        |
| --------------------------------------------------- | ----------------- | ------------------------------------------------------------ |
| ![](_images/manual/tables/cage_ladder_02.png)       | Ladder 2          | Must be placed next to a wall. [Altitude](/guide/scenery-editor/objects/properties) is referenced from the top of the object so will need to be adjusted ensure it matches the altitude of the building roof it is attached to |
